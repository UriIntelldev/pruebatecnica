...
({
  "./resources/gull/assets/js/script.js": (function(module, exports) {
...
/*          function requestFullScreen(el) {
          ...
          function requestFullScreen(element){
            ...
            $(".main-content-wrap").each(function(index) {
                var $el = $(this);
                var ps = new PerfectScrollbar(this, {
                    suppressScrollX: $el.data("suppress-scroll-x"),
                    suppressScrollY: $el.data("suppress-scroll-y")
      ...
      $(window).on("load", function() {
          ...
          if (typeof base_url !== "undefined") {
            jQuery.get( base_url('/admindashboard'), function( data ) {
                $('.contenido').html( data );
            });
          }
      ...
      (function(module, exports, __webpack_require__) {
          module.exports = __webpack_require__("./resources/gull/assets/js/script.js");
      })
